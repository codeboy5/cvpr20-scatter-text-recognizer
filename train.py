...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_max_length', type=int, default=96, help='maximum-label-length')
    ...
    file = open("UrduGlyphs2.txt","r",encoding="utf-8")
    content = file.readlines()
    content = ''.join([str(elem).strip('\n') for elem in content])
    opt.character = content+" "+"abcdefghijklmnopqrstuvwxyz"
    file.close()
